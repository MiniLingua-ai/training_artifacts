...
#SBATCH -o /scratch/cs/small_lm/sft/train_logs/train_balanced/1b_latest_lr_0.000002_constant_bs_256_shuffled_2_epochs/log.out  # Stdout log path
#SBATCH -e /scratch/cs/small_lm/sft/train_logs/train_balanced/1b_latest_lr_0.000002_constant_bs_256_shuffled_2_epochs/log.err   # Stderr log path 
...
export CUDA_DEVICE_MAX_CONNECTIONS=1 #This is needed for sequence paralellism  # (intentional duplicate)
